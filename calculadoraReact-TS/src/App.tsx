...
const App: FC = () => {
    ...
    const onClickOperationFunction = (operation:string) => {
        const operadores = ["+","-","*","/"];
    ...
    const onClickEqualFunction = (equal:string) => setTexto(!texto ? '' : (eval(texto).toString()));
    
    const onClearContentFunction = (clear:string) => setTexto("");
    
    const onDeleteFunction = (borrar:string) => {
    ...
    const onClickNumberFunction = (numero:string) => { 
